...
public record TimerItemHistoryRequest(
        ...
        @AssertTrue(message = "Done status must be true for historical items")
        Boolean done,

        @NotNull(message = "Goal cannot be null")
        Integer goal,

        @Positive(message = "Progress must be a positive number")
        Integer progress
) {}